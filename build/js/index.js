(function () {
  ...
  1: [function (require, module, exports) {
    var animations = {
      ...
      getHeaderHieght: function getHeaderHieght() {
        var headerHeight = this.vars.$header.height(); // use height of header to calculate next sections padding top
      ...
      scrollEvents: function scrollEvents() {
        ...
        $(window).scroll(function (event) {
          var scrollTop = $(this).scrollTop(); // scroll down
      ...
      mobileSlideDownLinks: function mobileSlideDownLinks() {
        $('.footer-links h4').click(function () {
          // open menu
          if (!$(this).hasClass('open')) {
            $(this).siblings('.link-container').slideDown(function () {
              $(this).siblings('h4').toggleClass('open');
            });
          } else {
            // close menu
            $(this).siblings('.link-container').slideUp(function () {
              $(this).siblings('h4').toggleClass('open');
            });
          }
        });
